<div class="table-responsive" class="">
    <table class="table table-flush" id="data-list-usuarios">
            ...
            <?php foreach ($lista as $item) :
                ...
                <tr class="<?= $visibilleStatus ?> status<?= $status ?>">
                    ...
                    <td class="text-center d-none config">
                        ...
                        <a href="" target="_blank" class="btn btn-danger p-2 mb-0">
                            <i class="fas fa-file-pdf text-white fa-fw"></i>
                        </a>
                        <a class="btn btn-dark p-2 mb-0" href="">
                            <i class="fas fa-history text-white fa-fw"></i>
                        </a>
                        <a href="" class="btn btn-info p-2 mb-0 position-relative">
